...
export const jobSeekerFeatures = [
    {
        ...
        description: 
          "AI-powered alorithm matches you with relevant opportunities based on your skills and preferences",
    },
    {
        icon: FileText,
        title: "Resume Builder",
        description:
            "Create professionnal resumes with our intuitive builder and templates designed by experts",
    },
    {
        icon:MessageSquare,
...
export const employerFeatures = [
    {
        ...
        description:
            "Access our vast database of pre-screened candidates and find the perfect fit your team.",
    },
    {
        icon: BarChart3,
    ...
    },
    {
        ...
        title: "Quick Hiring",
        description:
              "Streamlined hiring process reduces time-to-hire by 60% with automated sreening tools.",
    },
