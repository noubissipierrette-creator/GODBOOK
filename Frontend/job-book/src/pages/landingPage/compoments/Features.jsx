        ...
        <div className=" container mx-auto px-4 relative z-10" >
            <div className=" text-center mb-16">
                <h2 className=" text-4xl md:text-5xl font-bold text-gray-900 mb-6 ">
                    ...
                    <span className="block bg-gradient-to-r from-blue-600 bg-clip-text text-transparent ">
                        Succeed
                    </span>
                </h2>
                <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                  Whether you're looking for your next opportunity or the perfect
                 candidate, we have the tools and feartures to make it happen.  
                </p>
            </div>
            ...
            <div className=" grid md:grid-cols-2 gap-16 lg:gap-24 ">
                ...
                <div>
                    <div className="text-center mb-12">
                        <h3 className=" text-jxl font-bold text-gray-900 md-4 ">
                            For Job Seekers 
                         </h3> 
