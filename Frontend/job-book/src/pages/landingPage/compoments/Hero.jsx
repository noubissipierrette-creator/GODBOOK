...
const Hero = () => {
  ...
  return (
    <section className=" pt-24 pb-16 bg-white min-h-screen flex items-center">
        <div className=" container mx-auto px-4 ">
           ...
           <motion.h1
             ...
             className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-light pt-10"
       >
     ...
     <motion.p 
         initial={{opacity:0, y:30}}
          animate={{ opacity:1, y:0 }}
             ...
             className="text-xl md:text-xl text-gray-600 mb-12 max-w-2xl mx-auto leading-relaxe"
             >
                connect talented professionnals with innovation compagnies.
                Your next career move or perfect candidate is just ane click away.
             </motion.p>
    ...
    <div className="absolute inset-0 overflow-hidden pointer-events-none" >
         ...
         <div className="absolute  bottom-20 right-10 w-40 bg-purple-100 rounded-full blur-3xl opacity "/>
