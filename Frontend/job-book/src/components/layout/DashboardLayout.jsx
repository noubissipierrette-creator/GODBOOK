...
/>
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      >
        ...
        <div className="absolute bottom-4 left-4 right-4">
          <button
            onClick={logout}
            className="w-full flex items-center px-3 py-2.5 text-sm rounded-lg text-gray-600 hover:bg-gray-50"
          >
    ...
    >
        {/* Top navbar*/}
        <header className="bg-white/80 backdrop-blur-sm border-b border-gray-200 h-15 flex items-center justify-between px-6 sticky top-0 z-30">
            <div className="flex items-center space-x-4">
                {isMobile && (
                    <button
                    onClick={toggleSidebar}
                    className="p2 rounded-xl hover:bg-gray-100 transition-colors duration-colors duration-200"
                    >
                        {sidebarOpen ? (
